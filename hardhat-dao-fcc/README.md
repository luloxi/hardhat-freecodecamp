...
## Common hardhat errors

"deployScript.func is not a function" happens when we forget to "export default "functionName" on a deploy script or "module.exports"

**Mostly a copy-paste from Patrick's repo, because I couldn't find a certain bug**
